...
export const metadata: Metadata = {
  title: "Terms and Conditions — YourExitPlans",
  description: "Terms and conditions for YourExitPlans 3D animation services.",
  robots: {
    index: false,
    follow: false,
    noarchive: true,
              ...
              <div className="relative space-y-12">
                <header className="space-y-4">
                  ...
                  <p className="text-neutral-400 text-lg">
                    Welcome to YourExitPlans. By accessing our website, you agree to these terms and conditions. Please read
                    them carefully.
                  </p>
                </header>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    These Terms and Conditions govern your use of the YourExitPlans website and services. By using our
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Unless otherwise stated, YourExitPlans owns all the project files. This includes all electronic files,
                    drawings, source files, and any materials provided to the client, which remain the sole property of
                    YourExitPlans International, even if shared.
                  </p>
